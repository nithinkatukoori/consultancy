...
import { ExternalLink, Building, Users, TrendingUp, Award } from 'lucide-react';
  ...
  const candidates = [
    {
      ...
      company: "[Company Logo Placeholder]",
      industry: "Financial Services",
      testimonial: "Thanks to their strategic guidance, I secured a Senior BA role at a top financial firm with a 40% salary increase.",
      photo: "👩‍💼"
    },
    {
      name: "Michael Chen",
      ...
      company: "[Company Logo Placeholder]",
      industry: "Healthcare",
      testimonial: "The interview preparation was exceptional. I transitioned from reporting to strategic data analysis seamlessly.",
      photo: "👨‍💻"
    },
    {
      ...
      company: "[Company Logo Placeholder]",
      industry: "Consulting",
      testimonial: "Their LinkedIn optimization got me noticed by recruiters. Now I'm at my dream consulting firm.",
      photo: "👩‍💼"
    },
    {
      name: "David Park",
      ...
      company: "[Company Logo Placeholder]",
      industry: "Technology",
      testimonial: "The technical interview prep was game-changing. I felt confident discussing complex data scenarios.",
      photo: "👨‍💻"
    },
    {
      name: "Lisa Thompson",
      ...
      company: "[Company Logo Placeholder]",
      industry: "E-commerce",
      testimonial: "From application to offer letter, their support was comprehensive and results-driven.",
      photo: "👩‍💼"
    },
    {
      name: "James Wilson",
      ...
      testimonial: "They helped me transition from traditional analysis to advanced data science roles successfully.",
      photo: "👨‍💻"
    }
  ];
  ...
  const industryHighlights = [
    {
      ...
      title: "Fortune 500 Placements",
      description: "Placed analysts in Fortune 500 finance and consulting firms with comprehensive career support."
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Career Transitions",
      description: "Helped professionals transition into analytics from non-technical roles across various industries."
    },
    {
      icon: <TrendingUp className="h-6 w-6" />,
      title: "Diverse Industries",
      description: "Clients hired across healthcare, retail, IT analytics teams with specialized guidance."
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Premium Positions",
      description: "Specialized in placing candidates in senior-level positions with significant career advancement opportunities."
    }
  ];
      ...
      <section className="bg-gradient-to-br from-[#0A2540] to-[#008080] text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl lg:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
            We specialize in placing Business & Data Analysts in top organizations. Here are their inspiring success stories.
          </p>
