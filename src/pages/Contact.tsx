                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">thinksuccessITconsultants@gmail.com</div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">+91 80084 38080</div>
                        <div className="text-sm text-gray-500">
                          Mon–Fri, 9:00 AM – 6:00 PM (IST)<br />
                          US hours available on request
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">
                          ...
                          US availability by appointment (EST/CDT)
                        </div>
                      </div>
                    </div>
                  </div>
